...
Here are all the [platforms that SMAT monitors](https://docs.smat-app.com/docs/guides/data-guide)
...
"whos-cleaning-the-voter-rolls-soros-founded-and-funded-eric",
"eric-member-states",
...
"pennsylvania-gop-personal-voter-data-fraud-security-eric")
...
# write_csv(df_datawrapper_graph, here("data", "processed", "df_eric_datawrapper_20230604.csv"))
```
